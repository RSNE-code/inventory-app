  ...
  return (
    <div className="overscroll-fix">
      ...
      <div className="p-4 space-y-4">
        ...
        <button
          type="button"
          onClick={() => { window.location.href = queueTab === "DOOR_SHOP" ? "/assemblies/new?type=DOOR" : "/assemblies/new?type=PANEL" }}
  ...
  return (
    <>
      <Card
        ...
        onClick={() => { window.location.href = `/assemblies/${assembly.id as string}` }}
      >
