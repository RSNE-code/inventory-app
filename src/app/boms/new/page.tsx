...
export default function NewBomPage() {
  ...
  function handleProductSelect(product: { id: string; name: string; sku: string | null; unitOfMeasure: string; currentQty: number; pieceSize?: number | null; pieceUnit?: string | null }) {
    setLineItems((prev) => [
      ...prev,
      {
