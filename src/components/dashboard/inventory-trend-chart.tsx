    ...
    <Card className="px-3 pt-2.5 pb-2 rounded-xl border-border-custom shadow-brand">
      ...
      <div className="flex gap-1.5 overflow-x-auto pb-0.5 mt-0.5 scrollbar-hide">
        <button
          ...
          className={cn(
            "shrink-0 rounded-full px-3 py-1 text-[12px] font-semibold transition-all duration-200",
            categoryId === ""
              ? "bg-navy text-white"
        ...
        {categories.map((cat) => (
          <button
            ...
            className={cn(
              "shrink-0 rounded-full px-3 py-1 text-[12px] font-semibold transition-all duration-200 whitespace-nowrap",
              categoryId === cat.id
                ? "bg-navy text-white"
                : "bg-surface-secondary text-text-secondary hover:bg-border-custom"
            )}
      ...
      {/* Legend */}
      <div className="flex items-center justify-center gap-3 -mt-0.5 text-[12px] text-text-muted font-medium">
